...
from .plot_data import plot_data_hists, plot_datasets_energy

def make_distr_plots(h5_dir, h5_step, list_of_keys=None, Q_max=0.2):
    if list_of_keys is None:
        list_of_keys = ['train', 'test', 'val']
    path_to_save = Path(__file__).parent.parent.absolute() / 'data' / h5_dir
    path_to_h5 = path_to_save / h5_step
    plot_datasets_energy(path_to_h5)
...
if __name__ == '__main__':
    ...
    make_distr_plots(h5_dir, h5_step, list_of_keys, Q_max)
